...
const draw = () => {
  if (canvas.classList.contains("blackTheme")) {
    ...
    blackGround.style.background =
      "radial-gradient(circle, rgba(0,0,0,0.8603816526610644) 0%, rgba(0,0,0,0.7063200280112045) 41%, rgba(0,212,255,0) 70%)";
  } else {
    ...
    blackGround.style.background =
      "radial-gradient(circle, rgba(255,255,255,0.9051995798319328) 0%, rgba(255,255,255,0.7063200280112045) 41%, rgba(255,255,255,0) 70%)";
  }
};
